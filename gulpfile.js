...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('./urbit/app/escape/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/escape/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/escape/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/escape/js/'));
});

gulp.task('rename-index-min', function() {
  return gulp.src('./urbit/escape/js/index-min.js')
    .pipe(rename('index.js'))
    .pipe(gulp.dest('./urbit/escape/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('./urbit/app/escape/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/escape/js/'));
});

gulp.task('rename-tile-min', function() {
  return gulp.src('./urbit/app/escape/js/tile-min.js')
    .pipe(rename('tile.js'))
    .pipe(gulp.dest('./urbit/app/escape/js/'));
});

gulp.task('clean-min', function(){
  return del(['./urbit/app/escape/js/index-min.js', './urbit/app/escape/js/tile-min.js'], {force: true})
})
